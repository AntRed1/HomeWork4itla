...
import informacion.User_Signup;
...
public class Principal_Registro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnRegistro_en_Tabla.setText("Resgistrarse");
        ...
        btnVolverAtras_Login.setText("Volver Atras");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    .addComponent(btnRegistro_en_Tabla, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(btnVolverAtras_Login, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnRegistro_en_Tabla, javax.swing.GroupLayout.DEFAULT_SIZE, 55, Short.MAX_VALUE)
                    .addComponent(btnVolverAtras_Login, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(23, 23, 23))
        );
    ...
    private void btnRegistro_en_TablaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistro_en_TablaActionPerformed
        ...
        if (pass.equals(passconf)) {
            ...
            user.setNomb_user(txtRegistroUsuario.getText());
            user.setPassword(txtRegistroConstrasena.getText());
            user.setNombres(txtRegistroNombre.getText());
            user.setApellidos(txtRegistroApellido.getText());
